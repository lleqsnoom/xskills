...
/**
 * Run repro-web.js with the given error description and return { code, stdout, stderr }.
 */
...
describe("repro-web.js — happy path", () => {
...
describe("repro-web.js — error paths", () => {
