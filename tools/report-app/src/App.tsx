 ...
 * the screen is read again — cleared cache first, then the remount. Everything armed here is disarmed on
 * cleanup, because a listener that outlives its component is a listener nothing can take away.
 */
